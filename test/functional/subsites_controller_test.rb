...
class SubsitesControllerTest < ActionController::TestCase
  ...
  test "should create subsite" do
    assert_difference('Subsite.count') do
      post :create, subsite: { description: @subsite.description, name: @subsite.name, subdomain: @subsite.subdomain }
    end
  ...
  test "should update subsite" do
    put :update, id: @subsite, subsite: { description: @subsite.description, name: @subsite.name, subdomain: @subsite.subdomain }
    assert_redirected_to subsite_path(assigns(:subsite))
  end
